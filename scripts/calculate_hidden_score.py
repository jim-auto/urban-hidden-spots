...
FAMOUS_SPOTS = [
    # Shibuya
    ("スクランブルスクエア", 35.6584992, 139.7022144, "Tokyo (Shibuya)"),
    ("ハチ公像", 35.6590597, 139.7006279, "Tokyo (Shibuya)"),
    ("SHIBUYA109", 35.6591403, 139.6984603, "Tokyo (Shibuya)"),
    ("渋谷ヒカリエ", 35.6591803, 139.7036853, "Tokyo (Shibuya)"),
    ("渋谷ストリーム", 35.6572033, 139.7030975, "Tokyo (Shibuya)"),
    ("代々木公園", 35.6714052, 139.6951667, "Tokyo (Shibuya)"),
    # Namba
    ("道頓堀", 34.6686306, 135.5034000, "Osaka (Namba)"),
    ("戎橋", 34.6671000, 135.5014000, "Osaka (Namba)"),
    ("心斎橋筋商店街", 34.6706744, 135.5013256, "Osaka (Namba)"),
    ("なんばパークス", 34.6616791, 135.5020843, "Osaka (Namba)"),
    # Sakae
    ("サンシャインサカエ", 35.1694704, 136.9062885, "Nagoya (Sakae)"),
    ("オアシス21", 35.1710880, 136.9096446, "Nagoya (Sakae)"),
    ("名古屋テレビ塔", 35.1722971, 136.9083338, "Nagoya (Sakae)"),
    ("ラシック", 35.1675339, 136.9077215, "Nagoya (Sakae)"),
    ("三越 栄店", 35.1683368, 136.9087371, "Nagoya (Sakae)"),
    ("矢場町", 35.1631000, 136.9086000, "Nagoya (Sakae)"),
    # Shinjuku
    ("新宿駅南口", 35.6892000, 139.7003000, "Tokyo (Shinjuku)"),
    ("歌舞伎町", 35.6945000, 139.7027000, "Tokyo (Shinjuku)"),
    ("新宿御苑", 35.6851000, 139.7095000, "Tokyo (Shinjuku)"),
    ("都庁", 35.6897000, 139.6930000, "Tokyo (Shinjuku)"),
    ("新宿アルタ", 35.6927000, 139.7013000, "Tokyo (Shinjuku)"),
    # Ikebukuro
    ("池袋駅東口", 35.7298000, 139.7132000, "Tokyo (Ikebukuro)"),
    ("サンシャイン60", 35.7297814, 139.7170355, "Tokyo (Ikebukuro)"),
    ("池袋西口公園", 35.7302000, 139.7090000, "Tokyo (Ikebukuro)"),
    # Ueno
    ("上野公園", 35.7109000, 139.7735000, "Tokyo (Ueno)"),
    ("アメ横", 35.7101000, 139.7745000, "Tokyo (Ueno)"),
    ("上野動物園", 35.7153000, 139.7689000, "Tokyo (Ueno)"),
    ("東京国立博物館", 35.7190000, 139.7760000, "Tokyo (Ueno)"),
    # Yokohama
    ("横浜駅", 35.4660109, 139.6226361, "Yokohama"),
    ("みなとみらい", 35.4572000, 139.6328000, "Yokohama"),
    ("中華街", 35.4439000, 139.6467000, "Yokohama"),
    ("赤レンガ倉庫", 35.4518000, 139.6419000, "Yokohama"),
    ("山下公園", 35.4457000, 139.6499000, "Yokohama"),
    # Meieki
    ("名古屋駅", 35.1726000, 136.8818000, "Nagoya (Meieki)"),
    ("JRゲートタワー", 35.1723000, 136.8828000, "Nagoya (Meieki)"),
    ("ミッドランドスクエア", 35.1698000, 136.8852000, "Nagoya (Meieki)"),
    ("大名古屋ビルヂング", 35.1720000, 136.8845000, "Nagoya (Meieki)"),
    ("ナナちゃん人形", 35.1683000, 136.8848000, "Nagoya (Meieki)"),
    # Umeda
    ("梅田駅", 34.6995000, 135.4957000, "Osaka (Umeda)"),
    ("グランフロント大阪", 34.7038000, 135.4943000, "Osaka (Umeda)"),
    ("HEP FIVE", 34.7040592, 135.5003790, "Osaka (Umeda)"),
    ("梅田スカイビル", 34.7053000, 135.4905000, "Osaka (Umeda)"),
    ("ヨドバシ梅田", 34.7043860, 135.4962459, "Osaka (Umeda)"),
]
FAMOUS_RADIUS_M = 180
